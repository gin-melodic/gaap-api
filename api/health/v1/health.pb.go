...
const file_health_v1_health_proto_rawDesc = "" +
	...
	"\rHealthService\x124\n" +
	"\x06Health\x12\x14.health.v1.HealthReq\x1a\x14.health.v1.HealthResB\x1bZ\x19gaap-api/api/health/v1;v1b\x06proto3"
...
var file_health_v1_health_proto_depIdxs = []int32{
	0, // 0: health.v1.HealthService.Health:input_type -> health.v1.HealthReq
	1, // 1: health.v1.HealthService.Health:output_type -> health.v1.HealthRes

...
// Transport-level error returned for any failed ALE request.
...
var file_base_base_proto_goTypes = []any{
	...
	(*ErrorResponse)(nil),     // 4: base.ErrorResponse
	(*PaginatedResponse)(nil), // 5: base.PaginatedResponse
	(*Theme)(nil),             // 6: base.Theme
	(*ThemeColors)(nil),       // 7: base.ThemeColors
	(*AccountTypeConfig)(nil), // 8: base.AccountTypeConfig
	(*Money)(nil),             // 9: base.Money
}
var file_base_base_proto_depIdxs = []int32{
	7, // 0: base.Theme.colors:type_name -> base.ThemeColors
